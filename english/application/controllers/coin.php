...
class Coin extends CI_Controller { 
	...
	function index()
	{
		...
		$data['coinlist']		= $this->Coin_model->get_coin();
		$data['seodetails']		= $this->Coin_model->get_coinlist();
		$data['main_content']="coin/coin_manage";
	...
	function form()
	{
			...
			$this->Coin_model->save($coinId,$coin,$buy,$sell,$seotitle,$keyword,$details);
			redirect('coin/index', '');
	}
