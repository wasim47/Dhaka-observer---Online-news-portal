...
class Sport extends CI_Controller { 
	...
	function index()
	{
		...
		$data['sportlist']		= $this->Sport_model->get_sport();
		$data['seodetails']		= $this->Sport_model->get_sportlist();
		$data['main_content']="sport/sport_manage";
	...
	function form()
	{
			...
			$this->Sport_model->save($sportId,$sport_venue,$sporttime,$team1,$team2,$seotitle,$keyword,$details);
