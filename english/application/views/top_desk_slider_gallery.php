<div id="showcase" class="showcase">
         ...
         <?php
             foreach($topdesk_news_gallery as $desknews):
                ...
                $news_id=$desknews ->news_id;
                $short_description=$desknews ->short_description;
            ?>
		 <div class="showcase-slide">
			  <div class="lfttxt" >
			  	<div class="innerlf" >
			  		<p class="bold_txt"><a href="<?php echo base_url();?>index/news_details?id=<?php echo $news_id;?>&&cat_id=<?php echo $category;?>" style="text-decoration:none; color:#fff"><?php echo $headline; ?></a></p>
                    <?php 
                    ...
                    ?>
			  		<p><a href="<?php echo base_url();?>index/news_details?id=<?php echo $news_id;?>&&cat_id=<?php echo $category;?>" style="text-decoration:none; color:#fff; font-size:15px;"><?php echo $string1; ?></a></p>
			  	</div>
         </div>
         <div class="lftimg" ><a href="<?php echo base_url();?>index/news_details?id=<?php echo $news_id;?>&&cat_id=<?php echo $category;?>" style="text-decoration:none;"><img src="<?php echo base_url();?>uploads/images/news/<?php echo $image; ?>" width="467" height="270" class="img_ad1"></a></div>
		  </div>
