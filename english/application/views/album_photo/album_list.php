...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>gallery/approved?approve_val="+data;
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>gallery/deapproved?deapprove_val="+data;
			window.location.href=hrefdata;
	}
...
function deletedata(){
	...
	if(data=="")
	{
		...
		if(b==true){
			var hrefdata ="<?php echo base_url();?>album_photo/delete?pid="+data;
			window.location.href=hrefdata;
			}
			else{
			 return;
...
function openPage1(pid)
{
	var b = window.confirm('Are you sure, you want to Delete This ?');
	if(b==true)
		location.href= "<?php echo base_url();?>album_photo/delete?pid="+pid;
	else
	 return;
}
</script>
...
<div class="content-container">
    ...
    <div id="content-inner">
            ...
            <div style="display: none;" id="slickbox" class="toggle-container">
                <form name="formSearch" method="post" action="<?php echo base_url();?>gallery/index">
					     ...
					     <table style="height: auto;" role="grid" width="100%" cellspacing="0">
					       ...
					       <thead class="k-grid-header">
					         <tr>
					           ...
					           <th width="142" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#">gallery Headline</a></strong></th>
					           <th width="143" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#">gallery Title</a></strong></th>
					       ...
					       <tbody>
						    <?php
							$i=0;
							foreach($album_photolist as $albumphoto):
							$ph_id=$albumphoto->ph_id;
							$image=$albumphoto->ph_ima;
							$image_title=$albumphoto->ph_name;
							$status=$albumphoto->status;
							$i++;
							?>
					         <tr role="row" style="border-bottom:1px solid #CCCCCC">
					           <td class="" role="gridcell">
                               <input type="checkbox"  name="summe_code[]" id="summe_code<?php echo $i; ?>" value="<?php echo $ph_id;?>" /></td>
					           <td class="" role="gridcell"><?php echo $i;?></td>
					           <td class="" role="gridcell"><a href="#">
                          <img src="<?php echo base_url();?>uploads/images/album_photo/<?php echo $image;?>" title="<?php echo $image_title;?>"  width="70" />
                              </a></td>
							   ...
							   ?>                               </td>
                               <td class="" role="gridcell" align="center"><a href="<?php echo base_url();?>album_photo/updateData/<?php echo $ph_id; ?>"><img src="<?php echo base_url();?>assets/images/edit.png" title="Edit" alt="Edit" border="0" /></a>
                  &nbsp;&nbsp;
                  <a href="javascript:void(0)"  onClick="openPage1('<?php echo $ph_id;?>');">
