...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>banner/approved?approve_val="+data;
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>banner/deapproved?deapprove_val="+data;
			window.location.href=hrefdata;
	}
...
function deletedata(){
	...
	if(data=="")
	{
		...
		if(b==true){
			var hrefdata ="<?php echo base_url();?>banner/delete?cid="+data;
			window.location.href=hrefdata;
			}
			else{
			 return;
...
function openPage1(pid)
{
	var b = window.confirm('Are you sure, you want to Delete This ?');
	if(b==true)
		location.href= "<?php echo base_url();?>banner/delete?bid="+pid;
	else
	 return;
}
</script>
...
<div class="content-container">
    ...
    <div id="content-inner">
            ...
            <div style="display: none;" id="slickbox" class="toggle-container">
                <form name="formSearch" method="post" action="<?php echo base_url();?>banner/index">
					     ...
					     <table style="height: auto;" role="grid" width="100%" cellspacing="0">
					       ...
					       <thead class="k-grid-header">
					         <tr>
					           ...
					           <th width="142" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#">banner Headline</a></strong></th>
					           <th width="143" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#">Banner Title</a></strong></th>
                          ...
                          <img src="<?php echo base_url();?>uploads/images/banner/<?php echo $image;?>" title="<?php echo $image_title;?>"  width="70" />
							   ...
							   ?>                               </td>
                               <td class="" role="gridcell" align="center"><a href="<?php echo base_url();?>banner/updateData/<?php echo $banner_id; ?>"><img src="<?php echo base_url();?>assets/images/edit.png" title="Edit" alt="Edit" border="0" /></a>
                  &nbsp;&nbsp;
