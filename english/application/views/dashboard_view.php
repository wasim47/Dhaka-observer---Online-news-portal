              ...
              <li class="activeContent">
                    ...
                    <fieldset>
                        ...
                        <div class="tools-nav"><a href="<?php echo base_url();?>logo/index">
						                        ...
						                        <p class="tools-tip">Change Logo</p>
                    </a></div>
                     <div class="tools-nav"><a href="<?php echo base_url();?>banner/index">
						    ...
						    <!--<div class="tools-nav"><a href="<?php echo base_url();?>banner/create">
                              ...
                              <div class="tools-nav"><a href="<?php echo base_url();?>gallery/index">
                                 <div class="icon article-add-tools"><img src="<?php echo base_url();?>assets/images/article/article12.jpg" width="50" height="50" /></div>
                                 <p class="tools-tip">Photo Album</p></a>
                            </div>
                            
						    <!--<div class="tools-nav"><a href="<?php echo base_url();?>gallery/create">
                                                <div class="icon article-manage-tools">
                                                <img src="<?php echo base_url();?>assets/images/article/new.jpg" width="50" height="50" />
                                                </div>
                                                <p class="tools-tip">Add New Album</p>
						                        </a></div>-->
                                 ...
                                 <div class="icon article-add-tools"><img src="<?php echo base_url();?>assets/images/article/article12.jpg" width="50" height="50" /></div>
                                 <p class="tools-tip">Album Photos</p></a>
                            </div>
                            
						    <!--<div class="tools-nav"><a href="<?php echo base_url();?>album_photo/create">
                                                <div class="icon article-manage-tools">
                                                <img src="<?php echo base_url();?>assets/images/article/new.jpg" width="50" height="50" />
                                                </div>
                                                <p class="tools-tip">Add New Album Photo</p>
						                        </a></div>-->
