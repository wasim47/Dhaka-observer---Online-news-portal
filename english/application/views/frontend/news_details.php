...
<div class="container">
     	...
     	<div class="details_con1">
     		...
     		<div class="news_con_row_2">
				...
				<?php echo $news_details['auther_name'];?> : <br />Update On<?php echo $pdate.','.$ptime;?>
				</div>
             ...
             <div class="additional_info_container mb10 oh">
				<div class="oh pb1 top_comment_count_and_social">
					<div class="fr">
						<div class="bottom pb0"  style="float:right; text-align:right; vertical-align:bottom;margin-top:20px;">
