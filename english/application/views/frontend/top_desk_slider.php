<div id="showcase" class="showcase">
         <?php
             foreach($topdesk_news as $desknews):
		 ...
		 <div class="showcase-slide">
			  <div class="lfttxt" >
			  	<div class="innerlf" >
                    ...
                    if (strlen($string1) > 250) {
                        $stringCut = substr($string1, 0, 250);
                        $string1 = substr($stringCut, 0, strrpos($stringCut, ' ')).'.....'; 
                    }
                    ?>
			  		<p><a href="<?php echo base_url();?>index/news_details?id=<?php echo $n_id;?>&&cat_id=<?php echo $category;?>" style="text-decoration:none; color:#fff"><?php echo $string1; ?></a></p>
			  	</div>
         </div>
