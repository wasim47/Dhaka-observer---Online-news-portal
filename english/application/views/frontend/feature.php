<?php
		 	 $querynat="select * from news_manage where category='12' and top_news=1 and status=1 order by n_id desc limit 1";
				...
				?>
<div class="row14_sub_left">
			     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">Feature</a></div>
     				...
     				<div class="news_box_1">
						...
						<p class="common_news_content"><?php 
							...
							?>
                            <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdnat;?>&&cat_id=<?php echo $categorynat;?>" style="text-decoration:none; color:#333"><?php echo $stringbottom1nat; ?></a>
                            </p>
						<ul>
                        <?php
					 $queryl1="select * from news_manage where category='12' and n_id!='$newsIdnat' 
