...
<div class="right_box1">
     		<div class="most_read_news_area">
                ...
                <img src="<?php echo base_url();?>assets/images/front/logo_small.png" /></div>
                  <div class="most_read_news" id="mostViewd">Most Read </div>
              <div class="district_news" id="districtNews">District News</div>
  			</div>
            ...
            <?php
                ...
                <li><span>
                    ...
                    <?php //echo $stringbottom1;
					$stringbottom1nat = strip_tags($headline);
                            ...
                            //echo $stringbottom1nat.'('.$read_count.')'; 
            ...
            <ul>
				...
				$stringbottom1nat1 = strip_tags($headline1);
