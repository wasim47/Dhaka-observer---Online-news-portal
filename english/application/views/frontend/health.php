...
<div class="row11_sub_right">
			     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">Health</a></div>
						...
						<h4><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdnat;?>&&cat_id=<?php echo $categorynat;?>" style="text-decoration:none; margin-bottom:8px"><?php echo $titlenat; ?></a></h4>
                        <?php 
