            ...
            <div class="con_row3_right">
                ...
                <div class="rightbox_bottom_onnorokom" style="width:100%; float:left; max-height:270px;overflow:scroll; overflow-x:hidden; " id="ex3">
					<?php
                        ...
                        <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsId;?>&&cat_id=<?php echo $category;?>" style="text-decoration:none;"><div style="width:100%; height:auto; float:left; padding:5px; font-size:15px; font-family:Arial, Helvetica, sans-serif;  border-bottom:1px solid #CCCCCC">
 			...
 			<div class="clearfloat"></div>
				...
				$querynewssports="select * from news_manage where category = 6 and sub_category = 1  and top_news=1 and status=1 
						...
						<p class="common_news_content" style="height:67px; overflow:hidden">
							...
							if (strlen($stringbottom1nats) > 200) {
								$stringCutnats = substr($stringbottom1nats, 0, 200);
