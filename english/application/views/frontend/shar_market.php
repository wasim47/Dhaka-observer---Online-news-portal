<?php
$querynat="select * from news_manage where category='26' and top_news=1 and status=1 order by n_id desc limit 1";
...
<div class="row7_sub_right">
			     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">Trade &amp; Share</a></div>
						...
						<h5><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdnat;?>&&cat_id=<?php echo $categorynat;?>" style="text-decoration:none;"><?php echo $titlenat; ?></a></h5>
                        <?php 
						...
						<ul>
                        <?php
					 $queryl1="select * from news_manage where category='26' and n_id!='$newsIdnat' 
					 ...
					 ?>
	<li><span>
    <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdl1;?>&&cat_id=<?php echo $categoryl1;?>" style="text-decoration:none;">
    <?php 
