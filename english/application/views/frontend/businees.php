<?php
$querynat="select * from news_manage where category='5' and top_news=1 and status=1 order by n_id desc limit 1";
...
?>
<div class="row7_sub_left">
			     				<div class="common_header">Business &amp; Economy </div>
						...
						<ul>
                        <?php
					 $queryl1="select * from news_manage where category='5' and n_id!='$newsIdnat' 
