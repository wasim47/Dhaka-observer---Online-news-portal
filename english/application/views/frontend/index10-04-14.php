...
<div class="container">
    ...
    <div class="con_row3_left">
         ...
         <img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_short; ?>" width="100" height="69" style="float:left; width:100px; height:69px; padding:5px; margin-right:10px; border:1px solid #ccc;  "><strong style="color:#4E4E4E"><?php echo $title; ?></strong>
