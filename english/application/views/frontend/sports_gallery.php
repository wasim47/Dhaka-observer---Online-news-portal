...
<div class="details_con1">
           ...
           <a href='<?php echo $youtube_link;?>' class='iframe' style="font-size:11px; font-weight:normal; text-decoration:none;">
                    <img src="<?php echo base_url();?>uploads/images/vedio/<?php echo $image;?>" width="200" height="150" />
					<div class="vedio_icon_gallery"></div>
					</a>
...
<a href='<?php echo $youtube_link;?>' class='iframe' style="font-size:11px; font-weight:normal; text-decoration:none; position:absolute; z-index:300; margin-top:-55px; float:left; color:#fff; margin-left:157px; background-color:#1B1B1B; opacity:0.6; height:25px; width:40px;">Vedio</a>-->
    ...
    $(window).load(function() {
		...
		<link rel="stylesheet" href="<?php echo base_url();?>assets/nslider/default/default1.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php echo base_url();?>assets/nslider/nivo-slider1.css" type="text/css" media="screen" />
...
<div id="wrapper">
        <div class="slider-wrapper theme-default">
           ...
           $queryl1s="select * from news_manage where category='6' and top_news=1 and status=1 order by n_id desc limit 7";
			 ...
			 if($imagess!=''){
			?>
			<img src="<?php echo base_url();?>uploads/images/news/<?php echo $imagess; ?>" title="<?php echo $titlel1s;?>" width="440" height="280" style="width:440px; height:280px;"/>
			<?php
			}
			}
			?>
	...
	<li><span><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdl1;?>&&cat_id=<?php echo $categoryl1;?>" style="text-decoration:none;">
     			...
     			<div class="gallery_item" onMouseOver="this.style.opacity='0.6'" onMouseOut="this.style.opacity='1'">
                    ...
                    <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsId;?>&&cat_id=<?php echo $news_categorytop; ?>" style="text-decoration:none;">
                          <img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_short; ?>" title="<?php echo $image_title_short; ?>"  width="467" height="270"  class="gallery_img"/></a>
									...
									<div class="gallery_item_row_2"><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsId;?>&&cat_id=<?php echo $news_categorytop; ?>" style="text-decoration:none">
                                    <?php 
                         ...
                         <?php echo $title; ?>
							...
							?>
									<div class="gallery_item_row_3" style="height:60px;"><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsId;?>&&cat_id=<?php echo $news_categorytop; ?>" style="text-decoration:none; color:#333">
                            <?php 
							$stringbottom1sfc = strip_tags($short_description_short);
							if (strlen($stringbottom1sfc) > 150) {
								$stringCutsfc = substr($stringbottom1sfc, 0, 150);
								$stringbottom1sfc = substr($stringCutsfc, 0, strrpos($stringCutsfc, ' ')).'.....'; 
							}
							echo $stringbottom1sfc; 
							//echo $short_description_short; ?></a></div>
                    ...
                    <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsId;?>&&cat_id=<?php echo $news_categorytop; ?>" style="text-decoration:none;">
                         ...
                         <?php echo $title; ?>
							...
							?>
									<div class="gallery_item_row_3" style="height:60px;"><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsId;?>&&cat_id=<?php echo $news_categorytop; ?>" style="text-decoration:none; color:#333">
									<?php 
							$stringbottom1sf = strip_tags($short_description_short);
							if (strlen($stringbottom1sf) > 150) {
								$stringCutsf = substr($stringbottom1sf, 0, 150);
								$stringbottom1sf = substr($stringCutsf, 0, strrpos($stringCutsf, ' ')).'.....'; 
							}
							echo $stringbottom1sf; ?>
     		...
     		<div class="clearfloat"></div>	
							<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $cat_id; ?>&&scat_id=2&&page=1" style="color:#FFFFFF; text-decoration:none">Others</a></div>
     			...
     			<div class="gallery_item" onMouseOver="this.style.opacity='0.6'" onMouseOut="this.style.opacity='1'">
                    ...
                    <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsId;?>&&cat_id=<?php echo $news_categorytop; ?>" style="text-decoration:none;">
                         ...
                         <?php echo $title; ?>
                            ...
                            <?php 
							$stringbottom1s = strip_tags($short_description_short);
							if (strlen($stringbottom1s) > 150) {
								$stringCuts = substr($stringbottom1s, 0, 150);
								$stringbottom1s = substr($stringCuts, 0, strrpos($stringCuts, ' ')).'.....'; 
							}
							echo $stringbottom1s; ?></a></div>
                                        <!--<div class="gallery_item_row_4">
                                            <p class="more"><a href="#">More.... </a></p>
                                        </div>-->
     			</div>
     		...
     		<div class="details_con1_right">
							<div class="common_adbox_1"><img src="<?php echo base_url();?>assets/images/front/omega.jpg" width="344" height="400" class="smimg"></div>
							<div class="con_row-sp_right">
     						<div class="common_header" style="margin:27px 0 10px 0">Live Cricket Update</div>
								...
								<div class="common_adbox_1"><img src="<?php echo base_url();?>assets/images/front/ad1.jpg" width="330" height="110" class="smimg"></div><div class="common_eventbox_1">
			     					...
			     					<div class="common_eventbox_1_body">
			     						...
			     						<table width="100%" border="0" cellspacing="0" cellpadding="3" id="most_viewd">
                                                <tr>
                                                  <td align="center" bgcolor="#ccc" class="txt_3" >&nbsp;</td>
                                                  <td align="center" bgcolor="#ccc" class="txt_3" ><strong>Time</strong></td>
                                                  <td align="center" bgcolor="#ccc" class="txt_3"><strong>Team</strong></td>
                                                  <th align="center" bgcolor="#ccc" class="txt_3" widtd="6%">&nbsp;</th>
                                                  <td align="center" bgcolor="#ccc" class="txt_3" ><strong>VS</strong></td>
                                                  <th align="center" bgcolor="#ccc" class="txt_3" widtd="27%">Time</th>
                                                  <td align="center" bgcolor="#ccc" class="txt_3" >&nbsp;</td>
                                                </tr>
												<?php 
													...
													<tr>
														...
														<td width="20%" align="center"><?php echo $time;?></td>
														<td width="29%" align="center"><?php echo $team1;?></td>
														<td width="6%" align="center"><img src="<?php echo base_url();?>assets/images/01 (34).png" width="16" height="16" ></td>
													  <td width="13%" align="center"><span class="txt_3">বনাম</span></td>
													  <td width="22%" align="center"><?php echo $team2;?></td>
														<td width="5%" align="center"><img src="<?php echo base_url();?>assets/images/01 (41).png" width="16" height="16" ></td>
  </tr>
													  <?php
                                                      }
                                                      ?>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="3" id="district_news">
												...
												<?php 
													...
													<tr>
														<td width="5%" align="center">&nbsp;</td>
														<td width="20%" align="center"><?php echo $timef;?></td>
														<td width="29%" align="center"><?php echo $team1f;?></td>
														<td width="6%" align="center"><img src="<?php echo base_url();?>assets/images/01 (34).png" width="16" height="16" ></td>
													  <td width="13%" align="center"><span class="txt_3">বনাম</span></td>
													  <td width="22%" align="center"><?php echo $team2f;?></td>
														<td width="5%" align="center"><img src="<?php echo base_url();?>assets/images/01 (41).png" width="16" height="16" ></td>
  </tr>
													 <?php
													}
