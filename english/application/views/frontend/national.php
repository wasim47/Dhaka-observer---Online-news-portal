...
<div class="con_row2_col_1"><img src="<?php echo base_url();?>assets/images/front/ad1.jpg" width="330" height="110" class="img_ad1"></div>
     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">National </a></div>
     				...
     				<div class="news_box_1">
                        ...
                        <?php 
							...
							if (strlen($stringbottom1nat) > 180) {
							$stringCutnat = substr($stringbottom1nat, 0, 180);
