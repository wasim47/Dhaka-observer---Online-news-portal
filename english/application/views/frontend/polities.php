...
<div class="con_row2_col_2"><img src="<?php echo base_url();?>assets/images/front/ad2.jpg" width="330" height="110" class="img_ad1"></div>
     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">Politics</a></div>
						...
						<h4><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdnat;?>&&cat_id=<?php echo $categorynat;?>" style="text-decoration:none; margin-bottom:8px">
						
						<?php 
						$stringbottom1 = strip_tags($titlenat);
							if (strlen($stringbottom1) > 60) {
								$stringCut = substr($stringbottom1, 0, 60);
