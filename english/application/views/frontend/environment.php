...
<div class="row14_sub_right">
     							<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">Environment</a></div>
     				...
     				<div class="news_box_1">
                        ...
                        <h4 style="width:100%;"><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdnat;?>&&cat_id=<?php echo $categorynat;?>" style="text-decoration:none;">
						<?php 
						$stringbottom1 = strip_tags($titlenat);
					 ...
					 and status=1 order by n_id desc limit 8";
