    ...
    <div id="content-inner-middle">
        ...
        <div id="generalInfo">
            <fieldset class="fieldset">
                <legend class="legend">Category Setting</legend>
                <div class="form">
                    <div class="form-row">
                        <div class="label">
                            Category Name:<span class="required">*</span>                        </div>
                        
                        <div class="field">
                            
<input aria-describedby="ui-tooltip-0" name="category_name" id="category_name" size="50" class="ui-widget-content ui-corner-all" type="text"> 
                        </div>
                    </div>
