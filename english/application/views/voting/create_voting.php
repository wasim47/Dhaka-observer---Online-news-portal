...
<?php include("left_menu_voting.php");?>
	...
	<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>voting/form" enctype="multipart/form-data">
				...
				<fieldset class="fieldset">
                	<legend class="legend">General Information</legend>                    
						...
						<div class="field"><span class="field article-field">
						  <input name="title" id="title" size="100" type="text" />
						  </span>
						...
						<div class="field"><span class="field article-field">
                          <textarea name="headline" rows="5" cols="40" style="background-color:#FFFFFF; border:1px solid #ccc; color:#666666"></textarea>
						  </span>
						  <div class="input-errors" id="firstName_err"></div>
					      </div></div>
                        <div class="form-row">
                        ...
                        <span class="field article-field">
						  <input name="start_date" id="start_date" size="20" type="text" />
						  </span>
						  <div class="input-errors" id="firstName_err"></div>
					      </div>
                          </div>
						...
						<div class="field">
                        <span class="field article-field">
						  <input name="end_date" id="end_date" size="20" type="text" />
						  </span>
						  <div class="input-errors" id="firstName_err"></div>
					      </div></div>  
