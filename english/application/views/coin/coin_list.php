...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>coin/approved?approve_val="+data;
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>coin/deapproved?deapprove_val="+data;
			window.location.href=hrefdata;
	}
...
function deletedata(){
	...
	if(data=="")
	{
		...
		if(b==true){
			var hrefdata ="<?php echo base_url();?>coin/delete?cid="+data;
			window.location.href=hrefdata;
			}
			else{
			 return;
...
function openPage1(pid)
{
	var b = window.confirm('Are you sure, you want to Delete This ?');
	if(b==true)
		location.href= "<?php echo base_url();?>coin/delete?bid="+pid;
	else
	 return;
}
</script>
...
<div class="content-container">
    ...
    <div id="content-inner">
            ...
            <div style="display: none;" id="slickbox" class="toggle-container">
                <form name="formSearch" method="post" action="<?php echo base_url();?>coin/index">
                       ...
                       <form id="form_check" name="formUserSearch" method="post">
					     <table style="height: auto;" role="grid" width="100%" cellspacing="0">
					       ...
					       <thead class="k-grid-header">
					         <tr>
					           <th width="38" height="22" class="k-header style1" data-role="droptarget" role="columnheader" data-field="checkAll">
			                   <!--<input name="checkbox" onclick='checkedAll();' type="checkbox" />--></th>
					           <th width="40" class="k-header" data-role="sortable" role="columnheader" data-field="article_id" data-title="ID"><strong><a class="k-link" href="#">ID</a></strong></th>
					           <th width="140" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#">Coin Name</a></strong></th>
					           <th width="170" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#">Buy</a></strong></th>
					           <th width="170" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#">Sell</a></strong></th>
					           <th width="214" class="k-header" data-role="sortable" role="columnheader" data-field="article_date" data-title="Date"><strong><a class="k-link" href="#">Publish</a></strong></th>
					           
					           <th width="172" class="k-header" data-role="droptarget" role="columnheader" data-field="common_action" data-title="Action"><strong>Action</strong></th>
				             </tr>
				           </thead>
					       <tbody>
						    <?php
							...
							?>
					         <tr role="row" style="border-bottom:1px solid #CCCCCC">
                               ...
                               <input type="checkbox"  name="summe_code[]" id="summe_code<?php echo $i; ?>" value="<?php echo $coin_id;?>" /></td>
					           <td class="" role="gridcell"><?php echo $i;?></td>
					           <td class="" role="gridcell"><a href="#"><?php echo $coin_name;?></a></td>
					           <td class="" role="gridcell"><?php echo $buy;?></td>
					           <td class="" role="gridcell"><?php echo $sell;?></td>
							   ...
							   ?>                               </td>
                               <td class="" role="gridcell" align="center"><a href="<?php echo base_url();?>coin/updateData/<?php echo $coin_id; ?>"><img src="<?php echo base_url();?>assets/images/edit.png" title="Edit" alt="Edit" border="0" /></a>
                  &nbsp;&nbsp;
                  <a href="javascript:void(0)"  onClick="openPage1('<?php echo $coin_id;?>');">
