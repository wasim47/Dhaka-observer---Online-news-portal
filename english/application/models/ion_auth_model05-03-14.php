...
//#############################################################################################################	
	...
	public function register($username, $password, $email, $additional_data = array(), $groups = array())
	{
		...
		$data = array(
		    ...
		    'password'   => $password,
		    'email'      => $email,
		    'sm'    	 => $additional_data['sm'],
		    'wo'   		 => $additional_data['wo'],
		    'sa' 	     => $additional_data['sa'],
		    'pi'  	     => $additional_data['pi'],
		    'io'  	     => $additional_data['io'],		
		    'report'     => $additional_data['report'],
	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		$query = $this
                            ->db
                            ->select($this->identity_column . ', username, email, id, password, active, role, sm, wo, sa, pi, io, report, last_login')
...
//##############################################
  // login
//			CI_Session::init();
//		        CI_Session::set('role', $data['role']);
//			CI_Session::set('loggedIn', true);
//		        CI_Session::set('login', $data['username']);
			//redirect('wakeupboard');
