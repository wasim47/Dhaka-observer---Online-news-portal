...
<div class="details_con1">
     		<div class="details_con1_left">
                    ...
                    <div onClick="window.location.href='http://www.google.com';">
 <iframe width="200" height="150" src="<?php echo $youtube_link;?>"
                    ...
                    <a href='<?php echo $youtube_link;?>' id='iframe' class="iframe-link"></a>
                    </div>
...
<a href='<?php echo $youtube_link;?>' class='iframe' style="font-size:11px; font-weight:normal; text-decoration:none; position:absolute; z-index:300; margin-top:-55px; float:left; color:#fff; margin-left:157px; background-color:#1B1B1B; opacity:0.6; height:25px; width:40px;">Vedio</a>-->
	...
	<li><span><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdl1;?>&&cat_id=<?php echo $categoryl1;?>" style="text-decoration:none;">
						...
						<div class="clearfloat"></div>
							...
							<div class="lt_row"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $cat_id; ?>&&scat_id=1&&page=1" style="color:#FFFFFF; text-decoration:none">ক্রিকেট</a></div>
							<div class="clearfloat"></div>													     	
     		<div class="gallery">
				<?php 
     		...
     		<div class="clearfloat"></div>	
							<div class="lt_row"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $cat_id; ?>&&scat_id=2&&page=1" style="color:#FFFFFF; text-decoration:none">ফুটবল</a></div>
     		...
     		<div class="clearfloat"></div>	
							<div class="lt_row"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $cat_id; ?>&&page=1" style="color:#FFFFFF; text-decoration:none">অন্যান্য</a></div>
