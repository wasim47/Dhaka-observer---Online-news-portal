...
class Columist extends CI_Controller { 
	...
	function index()
	{
		$data['page_title']	="columist";
		$field_name= $this->input->post('field_name');
		$data['bannerlist']		= $this->Columist_model->get_banner($field_name);
		$data['main_content']="columist/banner_list";
         $this->load->view('deshboard_templete', $data);
	}
	function approved()
	{
		$approve_val=$this->input->get('approve_val');
		$data['category']=$this->Columist_model->get_category_approve($approve_val);   
		redirect('columist/index', '');
	}
	...
	function deapproved()
	{
		...
		$data['category']=$this->Columist_model->get_category_deapprove($deapprove_val);   
		redirect('columist/index', '');
	}
	function create()
	{
		...
		$data['main_content']="columist/create_banner";
         $this->load->view('deshboard_templete', $data);
	}
	function updateData($id)
	{
		...
		$data['categorys']		= $this->Category_model->all_catgory();
		$data['subcategorys']		= $this->Category_model->all_subcatgory();
		$data['bannerdata']=$this->Columist_model->get_banner_update($id);   
		$data['main_content']="columist/update_banner";
        $this->load->view('deshboard_templete', $data);
	}
	...
	function form()
	{
		...
		$config['upload_path'] = 'uploads/images/columist/';//$this->config->item('digital_products_path');
	...
	function link_form()
	{
		...
		/*if($this->upload->do_upload())
		{
			...
			$this->Columist_model->update($save);
			redirect('columist/index', '');
	}
	...
	********************************************************************/
	function delete()
	{
		...
		$this->Columist_model->delete_banner($id);
		redirect('columist/index', '');
	}
}
