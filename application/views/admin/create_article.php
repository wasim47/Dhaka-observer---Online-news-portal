                ...
                <fieldset class="fieldset">
                	<legend class="legend">Article Information</legend>                    
						...
						<div class="field"><span class="field article-field">
						  <input name="menu_title" id="menu_title" size="100" title="Name of Article" type="text" />
						  </span>
						...
						<div class="field"><span class="field article-field">
						  <input name="title" id="title" size="100" title="Enter a Title of Article Page" type="text" />
						  </span>
						...
						<textarea name="content" id="ajaxfilemanager"  rows="20" cols="60"></textarea>											
