<div id="nav">
    ...
    <div class="nav-body">
    	<ul>
        	        	<li class="profile">
            	<a href="<?php echo base_url();?>admin/edit_profile">User Profile</a>
            </li>
                       	
			            <li class="user">
            	<a href="<?php echo base_url();?>admin/index">Users Manage</a>
            </li>
                        
                        <li class="user-add selected">
            	<a href="<?php echo base_url();?>admin/user_account">Add Users</a>
            </li>
