...
?>                
		<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>admin/create_user">
                <fieldset class="fieldset">
                	<legend class="legend">Member Information</legend>                    
						...
						<input name="first_name" id="firstName" size="40" title="Type Your First Name" class="ui-widget-content ui-corner-all" admin="1" frontend="1" type="text">											
						...
						<input name="last_name" id="lastName" size="40" title="Enter Your Last Name" class="ui-widget-content ui-corner-all" admin="1" frontend="1" type="text">											
						...
						<input name="companyName" id="companyName" size="40" title="Type your Company Name" class="ui-widget-content ui-corner-all" admin="1" frontend="1" type="text">											
...
<input name="email" id="email" size="40" title="Type your Email Address correct. This will consider as your login ID" info="Type your Email Address correct. This will consider as your login ID" class="ui-widget-content ui-corner-all" admin="1" frontend="1" type="text">											
...
<input name="password_confirm" id="password_confirm" value="" size="40" class="ui-widget-content ui-corner-all" admin="1" frontend="1" type="password">											
										...
										<div class="form-row">
											...
											<div class="field">
                                        <select name="role_id[]" id="role_id" class="ui-widget-content ui-corner-all" style="width:150px;" multiple="multiple">
                                                                    <?php
...
<div class="input-errors" id="role_id_err"></div>
                              ...
                              <select name="user_type" id="user_type" class="ui-widget-content ui-corner-all" style="width:150px;">
                              		<option value="" label="_blank">User Type</option>
