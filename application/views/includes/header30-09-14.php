...
<a href="#" style="color:#000;text-align:right; float:right;" class="framUpLogo">
<!--<img src="<?php echo base_url();?>assets/images/front/navigation-up-frame_red.png">--></a>
</div>
...
<input type="radio" name="ponetic" onClick="makeUnijoyEditor('q');" value="bvkunijoy" >&nbsp;ইউনিজয়
    ...
    <div class="hc_logo">
     		<div class="col_1">
            <!--<img src="<?php echo base_url();?>assets/images/front/logo.png" width="148" height="84">-->
