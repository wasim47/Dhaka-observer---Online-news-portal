...
<input type="radio" name="ponetic" onClick="makeUnijoyEditor('q');" value="bvkunijoy" >&nbsp;ইউনিজয়
    ...
    <div class="hc_logo">
            ...
            <div class="col_2" style="width:400px;">
            <div id="whether" style="float:left; width:150px;"></div>
            <div style="float:left; width:50px; font-size:36px; margin-top:18px; margin-left:-5px; font-weight:bold;">C</div>
            </div>
