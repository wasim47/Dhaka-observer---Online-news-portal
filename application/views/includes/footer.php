...
<!--<img src="<?php echo base_url();?>assets/images/front/logo.png" width="148" height="84" class="fotter_logo" />-->
...
endforeach;
?><?php */?>
<li><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=23">বিজ্ঞাপন</a>|</li>
<li><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=25">আমাদের সম্পর্কে</a>|</li>
<li><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=26">যোগাযোগ</a>|</li>
</ul>
</div>
</div>
<div class="footer_section">
...
Block - A, Section - 11 Mirpur , Dhaka - 1216, Bangladesh Phone: 01833356588
  <br />
  E-mail : info@dhakaobserver.com </div>
</div>
