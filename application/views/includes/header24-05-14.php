...
href="https://twitter.com/dhakaobserverbd"
data-widget-id="426998620701720576">Tweets by @dhakaobserverbd</a>
     ...
     <header class="header_con">
     	<div class="hc_top">
          ...
          <!-- AddThis Follow BEGIN -->
			...
			<div class="hc_top_left" style="width:250px; padding-left:50px;">
...
<input type="radio" name="ponetic" onClick="makeUnijoyEditor('q');" value="bvkunijoy" >&nbsp;ইউনিজয
     				</div>
						<div class="t_field">
    ...
    <div class="hc_logo">
     		...
     		<iframe src="http://services.prothom-alo.com/cricket/cricket_live_score.php" frameborder="0" width="380" scrolling="no" height="50" marginwidth="0" style="height: 50px;">
    </iframe> 
