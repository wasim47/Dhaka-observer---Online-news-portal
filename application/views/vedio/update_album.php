...
<?php include("left_menu_album.php");?>
    ...
    <div id="content-inner">
		<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>vedio_gallery/link_form" enctype="multipart/form-data">
				...
				<fieldset class="fieldset">
                	<legend class="legend">General Information</legend>                    
					  ...
					  <div class="field"><span class="field article-field">
						  <input name="vedio_title" id="vedio_title" size="70" type="text"  value="<?php echo $gallerydata['photo_album_name'];?>"/>
						  </span>
						  <div class="input-errors" id="firstName_err"></div>
					      </div></div>
                         <div class="form-row">
                        <div class="label">Youtube Link:<span class="required">*</span>                        </div>
                        
                      <div class="field">
                    <input type="text" name="youtube_link" style="width:560px" value="<?php echo $gallerydata['vedio_link'];?>" />
                    <br />
                    <div style="color:#999; margin-left:30px; padding:5px;">(Exemple Link:&nbsp;&nbsp;&nbsp;//www.youtube.com/embed/OlpWh4Uhj10)</div>
        <!--<input type="file" name="userfile" id="file"/>
        <img src="<?php echo base_url();?>uploads/images/album/<?php echo $gallerydata['album_ima'];?>" width="30%" height="30%" />-->
<div class="input-errors" id="target_err"></div>
                        </div>
                    </div> 
                    <div class="form-row">
                        <div class="label">
                            Vedio Image:<span class="required">*</span>
                        </div>
                        
                        <div class="field">
                            
        <input type="file" name="userfile" id="file"/>
        <img src="<?php echo base_url();?>uploads/images/vedio/<?php echo $gallerydata['album_ima'];?>" width="30%" height="30%" />
<div class="input-errors" id="target_err"></div>
                        </div>
                    </div>
				</div>
                ...
                <fieldset class="fieldset">
                	<legend class="legend">SEO Information</legend>                    
						...
						<div class="field"><span class="field article-field">
				<input name="seo_title" id="seo_title" size="80" type="text" value="<?php echo $gallerydata['seo_title'];?>"/>
						  </span>
						  <div class="input-errors" id="firstName_err"></div>
					      </div>
                          </div>
						...
						<div class="field"><span class="field article-field">
						<input name="key_word" id="key_word" size="80" type="text" value="<?php echo $gallerydata['key_word'];?>" />
						  </span>
						  <div class="input-errors" id="firstName_err"></div>
					      </div>
                          </div>
						...
						<textarea name="seo_details" rows="5" cols="100" style="background-color:#FFFFFF; border:1px solid #ccc; color:#666666"><?php echo $gallerydata['seo_details'];?></textarea>											
                ...
                <input type="hidden" name="photo_album_id" value="<?php echo $gallerydata['photo_album_id'];?>" />
                  <input type="hidden" name="still_images" value="<?php echo $gallerydata['album_ima'];?>" /> 
