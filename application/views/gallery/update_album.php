...
<?php include("left_menu_album.php");?>
    ...
    <div id="content-inner">
		<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>gallery/link_form" enctype="multipart/form-data">
				...
				<fieldset class="fieldset">
                	<legend class="legend">General Information</legend>                    
                        ...
                        <div class="form-row">
						<div class="label label_class" style="">Select Category: </div>
			 ...
			 <select name="category" id="category" class="ui-widget-content ui-corner-all" style="width:150px;">
						...
						<div class="field"><span class="field article-field">
						  <input name="photo_album_name" id="photo_album_name" size="70" type="text"  value="<?php echo $gallerydata['photo_album_name'];?>"/>
						  </span>
						  <div class="input-errors" id="firstName_err"></div>
					      </div></div>
                         <div class="form-row">
