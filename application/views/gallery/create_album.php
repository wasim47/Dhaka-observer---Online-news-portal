...
<?php include("left_menu_album.php");?>
    ...
    <div id="content-inner">
		<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>gallery/form" enctype="multipart/form-data">
			 ...
			 <select name="category" id="category" class="ui-widget-content ui-corner-all" style="width:150px;">
						...
						<div class="form-row">
						<div class="label label_class" style="">album title : </div>
						
						<div class="field"><span class="field article-field">
						  <input name="photo_album_name" id="photo_album_name" size="70" type="text" />
						  </span>
						  <div class="input-errors" id="firstName_err"></div>
					      </div></div>
                         <div class="form-row">
