...
function deletedata(){
	...
	if(data=="")
	{
		...
		if(b==true){
			var hrefdata ="<?php echo base_url();?>gallery/delete?cid="+data;
			window.location.href=hrefdata;
			}
			else{
			 return;
...
function openPage1(pid)
{
	var b = window.confirm('Are you sure, you want to Delete This ?');
	if(b==true)
		location.href= "<?php echo base_url();?>gallery/delete?bid="+pid;
	else
	 return;
}
</script>
                     ...
                     <div class="k-grid k-widget">
                       ...
                       <form id="form_check" name="formUserSearch" method="post">
					     <table style="height: auto;" role="grid" width="100%" cellspacing="0">
                          ...
                          <img src="<?php echo base_url();?>uploads/images/album/<?php echo $image;?>" title="<?php echo $image_title;?>"  width="70" />
                              </a></td>
							   ...
							   ?>                               </td>
                               <td class="" role="gridcell" align="center"><a href="<?php echo base_url();?>gallery/updateData/<?php echo $gallery_id; ?>"><img src="<?php echo base_url();?>assets/images/edit.png" title="Edit" alt="Edit" border="0" /></a>
                  &nbsp;&nbsp;
