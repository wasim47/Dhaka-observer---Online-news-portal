            ...
            <div style="display: none;" id="slickbox" class="toggle-container">
                <form id="formUserSearch" name="formUserSearch" method="post" action="">
                    ...
                    <div class="clr form-button-container">
					 ...
					 <tr style="box-shadow:#ccc 2px 0px 2px 0px; font-weight:bold" bgcolor="#E2E2E2">
					 	<td class="" role="gridcell"><input value="2" class="check_btn" type="checkbox"></td>
						<td class="" role="gridcell">SI</td>
					...
					<?php if($i%2!=0)
						 { $c="#eaeaea";
							...
							$c="#FBFBFB"; } ?>
					<tr bgcolor="<?php echo $c; ?>" style="box-shadow:#ccc 2px 0px 2px 0px">
					 	<td class="" role="gridcell"><input name="checkbox" type="checkbox" class="check_btn" value="2" /></td>
					 	<td class="" role="gridcell"><?php echo $i; ?></td>
						<td class="" role="gridcell"><?php echo $user->email; ?></td>
						<td class="" role="gridcell"><?php echo $user->first_name.$user->last_name; ?></td>
						<td class="" role="gridcell"><?php echo $user->role; ?></td>
						<td class="" role="gridcell" align="center"><?php echo $user->last_login; ?></td>
						<td class="" role="gridcell" align="center"><?php echo $user->created_on; ?></td>
						...
						<img src="<?php echo base_url();?>assets/images/user-active.gif" border="0"></a> <a href="<?php echo base_url();?>dashboard/user_del/<?php echo $user->id; ?>" class="delete_btn" ><img src="<?php echo base_url();?>assets/images/user-delete.gif" title="Delete" alt="Delete" border="0"></a></td></tr>
