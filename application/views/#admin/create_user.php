...
<input name="email" id="username" size="40" title="Type your Email Address correct. This will consider as your login ID" info="Type your Email Address correct. This will consider as your login ID" class="ui-widget-content ui-corner-all" admin="1" frontend="1" type="text">											
...
<input name="password_confirm" id="confirmPassword" value="" size="40" class="ui-widget-content ui-corner-all" admin="1" frontend="1" type="password">											
