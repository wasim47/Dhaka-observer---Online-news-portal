...
<div class="content-container">
    ...
    <div id="content-inner"  style="float:left; width:100%">
		<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>cricket/form" enctype="multipart/form-data">
...
<input name="sporttime<?php echo $i;?>" id="timecal<?php echo $i;?>" size="10" type="text" value="<?php echo $time; ?>" onclick="timecalender(<?php echo $i;?>);" />
