...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>index.php/columist_article/approved?approve_val="+data;
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>index.php/columist_article/deapproved?deapprove_val="+data;
			window.location.href=hrefdata;
	}
...
function deletedata(){
	...
	if(data=="")
	{
		...
		if(b==true){
			var hrefdata ="<?php echo base_url();?>index.php/columist_article/delete?cid="+data+"&&catId="+catId;
			window.location.href=hrefdata;
			}
			else{
			 return;
...
function openPage1(pid)
{
	...
	var b = window.confirm('Are you sure, you want to Delete This ?');
	if(b==true)
		location.href= "<?php echo base_url();?>index.php/columist_article/delete?cid="+pid+"&&catId="+catId;
	else
	 return;
}
</script>
...
<div class="title-container">
	<div class="user-all">
	  <h1>Columist Article Management</h1>
	</div>
...
<div class="content-container">
    ...
    <div id="content-inner">
            ...
            <div style="display: none;" id="slickbox" class="toggle-container">
                <form id="formSearch" name="formSearch" method="post" action="<?php echo base_url();?>index.php/columist_article/index">
					     ...
					     <table style="height: auto;" role="grid" width="100%" cellspacing="0">
					       ...
					       <thead class="k-grid-header">
					         <tr>
					           ...
					           <th width="285" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#"> Headline</a></strong></th>
					           ...
					           <th width="119" class="k-header" data-role="sortable" role="columnheader" data-field="article_date" data-title="Date"><strong><a class="k-link" href="#">Columist</a></strong></th>
					       ...
					       <tbody>
							...
							$i++;
                          	...
                          	$cat_query=mysql_query("select * from category where cid='$category'");
                          ...
                          <img src="<?php echo base_url();?>uploads/images/columist_article/<?php echo $image;?>" width="100%" title="<?php echo $image_title;?>" height="100%" />
                              </a></td>
							   ...
							   ?>                               </td>
					           <td class="" role="gridcell" align="center"><a href="<?php echo base_url();?>index.php/columist_article/updateData/<?php echo $news_id; ?>"><img src="<?php echo base_url();?>assets/images/edit.png" title="Edit" alt="Edit" border="0" /></a>
                  &nbsp;&nbsp;
