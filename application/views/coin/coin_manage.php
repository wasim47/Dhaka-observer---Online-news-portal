                         ...
                         <table width="53%" border="1" bordercolor="#AEAEAE" align="left" cellspacing="2" cellpadding="2" style="border-collapse:collapse; padding:10px; margin:0 20%">
                          <tr>
                           ...
                           <?php
							...
							?>
                            <tr>
                            <td style="padding:10px;"><input name="coin<?php echo $i;?>" id="image_title" size="20" type="text"  placeholder="Coin name" onfocus="this.placeholder=''" onblur="this.placeholder='Coin name'" value="<?php echo $coin_name; ?>"/>
                            </td>
