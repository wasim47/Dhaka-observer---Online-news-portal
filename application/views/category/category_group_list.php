...
<div class="content-container">
    ...
    <div id="content-inner">
    	        	<div class="toggle-link"><a href="#" id="slick-slidetoggle" class="user-icon">সার্চ ক্যাটাগরি</a></div>
                	...
                	<div class="toggle-search">
                    	<div class="toggle-row">
                        	<div class="toggle-label">
                            	<span class="label">সার্চ বাই নাম</span>
                            </div>
					     ...
					     <table style="height: auto;" role="grid" width="100%" cellspacing="0">
					       ...
					       <thead class="k-grid-header">
					         <tr>
					           ...
					           <th width="25" class="k-header" data-role="sortable" role="columnheader" data-field="article_id" data-title="ID"><strong><a class="k-link" href="#">আইডি</a></strong></th>
					           <th width="216" class="k-header" data-role="sortable" role="columnheader" data-field="article_name" data-title="Title"><strong><a class="k-link" href="#">সাব ক্যাটাগরি নাম</a></strong></th>
					           <th width="118" class="k-header" data-role="sortable" role="columnheader" data-field="article_date" data-title="Date"><strong><a class="k-link" href="#">তারিখ</a></strong></th>
					           <th width="96" class="k-header" data-role="sortable" role="columnheader" data-field="article_status" data-title="Publish"><strong><a class="k-link" href="#">পাবলিশ</a></strong></th>
					           <th width="162" class="k-header" data-role="droptarget" role="columnheader" data-field="common_action" data-title="Action"><strong><a class="k-link" href="#">অ্যাকশান</a></strong></th>
				             </tr>
				           </thead>
					       <tbody>
						    <?php
