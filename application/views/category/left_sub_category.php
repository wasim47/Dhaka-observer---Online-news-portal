...
<div id="nav">
    <div class="nav-header"><div class="nav-title">Category</div></div>
    <div class="nav-body">
    	<ul>
        	        	<!--<li class="profile">
            ...
            <li class="user" id="manage">
            	<a href="<?php echo base_url();?>category/category_list">Sub Category Manage</a>
            </li>
                        
            <li class="user-add selected">
            	<a href="<?php echo base_url();?>category/category_create">New Sub Category</a>
            </li>      	
