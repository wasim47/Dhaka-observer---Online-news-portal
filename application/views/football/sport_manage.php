...
<div class="content-container">
    ...
    <div id="content-inner"  style="float:left; width:100%">
		<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>football/form" enctype="multipart/form-data">
...
<input name="sporttime<?php echo $i;?>" id="image_title2" size="10" type="text"  id="timecal<?php echo $i;?>" value="<?php echo $time; ?>"  onclick="timecalender(<?php echo $i;?>);"/>
                            <input type="hidden" name="sportId<?php echo $i;?>" value="<?php echo $sport_id; ?>" />
                            </td>
                          </tr>
                           <?php
