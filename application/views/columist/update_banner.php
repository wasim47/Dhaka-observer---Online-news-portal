...
<?php include("left_menu_banner.php");?>
    ...
    <div id="content-inner">
		<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>columist/link_form" enctype="multipart/form-data">
				...
				<fieldset class="fieldset">
                	<legend class="legend">General Information</legend>                    
						...
						<div class="form-row">
						<div class="label label_class" style="">Columist title : </div>
					  ...
					  <div class="field"><span class="field article-field">
                         ...
                         <div class="form-row">
                        <div class="label">
                            Columist Image:<span class="required">*</span>                        </div>
