...
<div class="content-container">
    ...
    <div id="content-inner">
    	        	<div class="toggle-link"><a href="#" id="slick-slidetoggle" class="user-icon">Search User</a>
                    &nbsp;&nbsp;&nbsp;
                    <a href="<?php echo base_url();?>news/all_news" target="_blank" class="user-icon">All News</a>
                    </div>
                     ...
                     <div class="k-grid k-widget">
                       ...
                       <form id="form_check" name="formUserSearch" method="post">
					     <table style="height: auto;" role="grid" width="100%" cellspacing="0">
					       ...
					       <tbody>
                          <tr><td colspan="11"><div style=" width:100%; float:left;max-height:740px; overflow:scroll; overflow-x:hidden">
                          <table width="100%">
						    <?php
							$i=0;
							...
							?>
					         <tr role="row" style="border-bottom:1px solid #CCCCCC">
					           ...
					           <td class="" role="gridcell"><a href="#"><?php echo $scat_name; ?></a></td>
					           <td class="" role="gridcell"><a href="#">
                          <img src="<?php echo base_url();?>uploads/images/news/<?php echo $image;?>" width="70" title="<?php echo $image_title;?>" height="70" />
                              </a></td>
