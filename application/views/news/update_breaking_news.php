...
<?php include("left_menu_news.php");?>
    ...
    <div id="content-inner">
		<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>news/breaking_news_link_form" enctype="multipart/form-data">
...
<div class="input-errors" id="target_err"></div>
						...
						<div class="field"><span class="field article-field">
						  <input name="vedio" id="vedio" style="width:250px;" type="text"  value="<?php echo $newsdata['vedio'];?>"/>
