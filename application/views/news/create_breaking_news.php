...
<form name="MemberForm" id="MemberForm" method="post" action="<?php echo base_url();?>news/breaking_news_form" enctype="multipart/form-data">
				<fieldset class="fieldset">
					...
					<select name="sub_category" id="sub_category" class="ui-widget-content ui-corner-all" style="width:150px;">
						...
						<div class="field"><span class="field article-field">
						  <input name="time_line" id="timecal" size="10" type="text"/>
...
<div class="input-errors" id="target_err"></div>
						...
						<div class="field"><span class="field article-field">
                          ...
                          <div class="form-row">
						<div class="label label_class" style="">Vedio : </div>
						
						<div class="field"><span class="field article-field">
						  <input name="vedio" id="vedio" type="text" style="width:250px;" />
                          Top Content: &nbsp;
