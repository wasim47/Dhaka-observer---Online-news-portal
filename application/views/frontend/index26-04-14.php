            ...
            <div class="con_row3_right">
                ...
                <div class="rightbox_bottom_onnorokom" style="width:100%; float:left; max-height:270px;overflow:scroll; overflow-x:hidden; " id="ex3">
					<?php
                        ...
                        <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsId;?>&&cat_id=<?php echo $category;?>" style="text-decoration:none;"><div style="width:100%; height:auto; float:left; padding:5px;  border-bottom:1px solid #CCCCCC">
                    
         <img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_short; ?>" width="100" height="69" style="float:left; width:100px; height:69px; padding:5px; margin-right:10px; border:1px solid #ccc;  "><strong><?php echo $title; ?></strong>
 			...
 			<div class="clearfloat"></div>
				...
				$querynewssports="select * from news_manage where category = 6 and sub_category = 1  and top_news=1 and status=1 
						...
						<h4>
                            ...
                            <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdesp;?>&&cat_id=<?php echo $category_sport;?>" style="text-decoration:none; margin-bottom:8px;"><?php 
                        ...
                        <?php
                            ...
                            <?php
			     			...
			     			<div class="row8_sub_right"><div class="common_adbox_sports"><img src="<?php echo base_url();?>assets/images/front/ad7.jpg" width="352" height="48" class="smimg" style="padding:0px; margin:0px;"></div>
                        		...
                        		<?php
				$querynewsFootbal="select * from news_manage where category = 6 and sub_category!= 1 and n_id!='$newsIdesp' and top_news=1 and status=1 order by n_id desc limit 1";
...
<a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdeFt;?>&&cat_id=<?php echo $category_Ft;?>" style="text-decoration:none;"><img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_shorteFt; ?>" width="660" height="439" class="smimg"></a></div>
     							<div class="news_box_1">
                                    <h4>
                                                                <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdeFt;?>&&cat_id=<?php echo $category_Ft;?>" style="text-decoration:none; margin-bottom:8px;"><?php echo $titleeFt; ?></a>
                                                            </h4>
                                    <p class="common_news_content" style="height:67px; overflow:hidden">
                                    ...
                                    <ul style="margin-bottom:5px;">
                                    <?php
    $queryFt="select * from news_manage where category='6' and sub_category!= 1 and n_id!='$newsIdeFt' and status=1 order by n_id desc limit 4";
							...
							if (strlen($stringbottom1s11) > 50) {
								...
								$stringbottom1s11 = substr($stringCuts11, 0, strrpos($stringCuts11, ' ')); 
							}
			     		...
			     		<div class="con_row10_left">
			     			<div class="row10_sub_left">
							  ...
							  ?>
                                    ...
                                    <div class="news_box_1">
						<h4>
                            <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIde1;?>&&cat_id=<?php echo $categoryl2e;?>" style="text-decoration:none; margin-bottom:8px;"><?php echo $titlee1; ?></a>
						</h4>
						<p class="common_news_content" style="height:67px;">
						
                            <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIde1;?>&&cat_id=<?php echo $categoryl2e;?>">
							<?php 
							$stringbottom1e1e1 = strip_tags($short_description_shorte1);
							if (strlen($stringbottom1e1e1) > 200) {
								$stringCute1e1 = substr($stringbottom1e1e1, 0, 200);
								$stringbottom1e1e1 = substr($stringCute1e1, 0, strrpos($stringCute1e1, ' ')); 
							}
							echo $stringbottom1e1e1;
							//echo $short_description_shorte1; ?></a>
                            </p>
						<ul style="margin-bottom:5px;">
                        <?php
...
<a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdeBL1;?>&&cat_id=<?php echo $category_BL1;?>" style="text-decoration:none;"><img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_shorteBL1; ?>" width="600" height="400" class="smimg"></a></div>
								<div class="news_box_1">
						<h4>
                            <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdeBL1;?>&&cat_id=<?php echo $category_BL1;?>" style="text-decoration:none; margin-bottom:8px;"><?php echo $titleeBL1; ?></a>
						</h4>
						<p class="common_news_content" style="height:67px;">
						
                            <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdeBL1;?>&&cat_id=<?php echo $category_BL1;?>">
							<?php 
							$stringbottom1e1e = strip_tags($short_description_shorteBL1);
							if (strlen($stringbottom1e1e) > 200) {
								$stringCute1e = substr($stringbottom1e1e, 0, 200);
								$stringbottom1e1e = substr($stringCute1e, 0, strrpos($stringCute1e, ' ')); 
							}
							echo $stringbottom1e1e;
							//echo $short_description_shorteBL1; ?></a>
                            </p>
						<ul style="margin-bottom:5px;">
                        <?php
	...
	<div class="con_row13">
     				...
     				<div class="common_header">Prayer Time Schedule  </div>
 ...
 <!--<iframe width="100" height="80" src="<?php echo $youtube_link;?>"
    ...
    <div class="popular_news">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" align="left">
                            ...
                            <tr>
                            <?php
                        $queryPop="select * from photo_album group by category order by photo_album_id asc limit 4";
                        ...
                        ?>
     					...
     					<div class="con_row17_right">
										...
										<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=27&&page=1">Travel & Landscape</a></div>	
