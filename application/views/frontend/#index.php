...
<div class="container">
    ...
    <div class="con_row3_left">
	   	...
	   	<div class="clearfloat"></div>
     		...
     		<div class="con_row3_right">
     			<div class="common_header">সাম্প্রতিক খবর</div>
     	...
     	<div class="clearfloat"></div>
 			<div class="clearfloat"></div>
			     	...
			     	<div class="con_row8">
			     		<div class="con_row8_left">
			     			<div class="row8_sub_left">
			     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=6">খেলাধুলা </a></div>
                                <?php
			     	...
			     	<div class="con_row10">
			     		<div class="con_row10_left">
			     			<div class="row10_sub_left">
			     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=7">বিনোদন</a></div>
                                <?php
							  ...
							  ?>
			     				...
			     				<div class="common_eventbox_1">
			     					<div class="common_eventbox_1_header">কালচারাল ইভেন্টস</div>
										
			     					<div class="common_eventbox_1_body">
			     		
			     						<table width="100%" border="0" cellspacing="0" cellpadding="3">
												<tr>
													<th bgcolor="#e71b1c" class="txt_2" scope="col">অনুষ্ঠান</th>
													<th bgcolor="#e71b1c" class="txt_2" scope="col">থিয়েটার</th>
													<th bgcolor="#e71b1c" class="txt_2" scope="col">তারিখ</th>
													<th bgcolor="#e71b1c" class="txt_2" scope="col">সময়</th>
												</tr>
												 <?php 
     				...
     				<div class="clearfloat"></div>
						...
						<div class="common_eventbox_1">
			     					<div class="common_eventbox_1_header">থিয়েটার ইভেন্টস</div>
     					...
     					<div class="con_row10_right">
     						<div class="common_header">সিনে টাইম্‌স</div>
						...
						<p><?php echo $voting_value['voting_sub'];?></p>
							  ...
							  <div class="pollrow_1">
								  <div class="pollrow_lft">
								    <input name="Submit" type="submit" class="button_vote" value="ভোট দিন" />
								  </div>
	...
	margin:0px;">
							...
							?>
                            <h5 style="padding:0px; margin:0px; padding-top:10px; font-size:14px">মোট ভোট সংখ্যা &nbsp; - &nbsp;<?php echo $totalResults;?></h5>
							  <div class="pollrow_1">
								  <div class="pollrow_lft">
	...
	<div class="con_row13">
     				...
     				<div class="clearfloat"></div>
  					...
  					<div class="con_row14_right">		<div class="common_header">আবহাওয়া বার্তা</div>
     				...
     				<div class="common_header">জব কর্নার</div>
