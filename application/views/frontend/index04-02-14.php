...
<a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdeFt;?>&&cat_id=<?php echo $category_Ft;?>" style="text-decoration:none;"><img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_shorteFt; ?>" width="660" height="439" class="smimg"></a></div>
			     	...
			     	<div class="con_row10">
						...
						<ul style="margin-bottom:5px;">
                        <?php
    						$queryl1="select * from news_manage where category='7'  and sub_category = 5 and news_id!='$newsIde1' 
...
<a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdeBL1;?>&&cat_id=<?php echo $category_BL1;?>" style="text-decoration:none;"><img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_shorteBL1; ?>" width="600" height="400" class="smimg"></a></div>
						...
						<ul style="margin-bottom:5px;">
                        <?php
    						$queryBL="select * from news_manage where category='7' and sub_category != 5 and news_id!='$newsIdeBL1' 
							and status=1 order by news_id desc limit 4";
						...
						<div class="common_eventbox_1">
     					...
     					<div class="con_row10_right">
     						<div class="common_header">গুজব</div>
	...
	<div class="con_row13">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" align="left" style="border:0px; width:auto">
                        	<tr><td><div class="common_header">আলোচিত সংবাদ</div></td></tr>
                            <tr>
                            <?php
                        $queryPop="select * from news_manage where status= '1' and popular_news = '1' order by news_id desc limit 3";
                         $resultPop=mysql_query($queryPop);
                         while($rowPop=mysql_fetch_array($resultPop)){
                         $titlePop=$rowPop['headline'];
                         $newsIdPop=$rowPop['news_id'];
                        ...
                        ?>
                            	<td valign="top">
                                	<table cellpadding="0" cellspacing="0" border="0" style="border:0px;width:autos">
                                        <tr>
                                            <td valign="top">
                                                ...
                                                <img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_shortPop; ?>" width="100" height="69" style="float:left; width:180px; height:130px; padding:5px; margin-right:10px; border:1px solid #ccc; ">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td> <a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdPop;?>&&cat_id=<?php echo $categoryPop;?>" style="text-decoration:none; color:#000; border:none"><?php echo $titlePop; ?></a></td>
                                        </tr>
                                    </table>
                                </td>
						<?php 
