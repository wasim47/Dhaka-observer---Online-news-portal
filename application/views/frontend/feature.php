...
<div class="row14_sub_left">
			     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">ফিচার</a></div>
     				...
     				<div class="news_box_1">
						...
						<p class="common_news_content" style="height:100px;">
						<?php 
