...
<div id="wrapper" style="margin-top:10px;">
 ...
 <!--<iframe width="100" height="80" src="<?php echo $youtube_link;?>"
                    ...
                    <?php
				    $resp2=mysql_query("select * from vedio_gallery where photo_album_id!='$vedio_id1' order by photo_album_id desc limit 2");
					$count = 0;
 ...
 <!--<iframe width="100" height="80" src="<?php echo $youtube_link;?>"
    ...
    <div class="popular_news">
				...
				<div class="clearfloat"></div>		
                <div style="width:100%; text-align:center; margin:auto; padding:20px 0px 10px 0px;">
