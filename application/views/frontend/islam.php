...
<body>
<?php
$querynat="select * from news_manage where category='32' and top_news=1 and status=1 order by n_id desc limit 1";
...
<div class="row4_sub_left">
                    ...
                    <a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">ইসলাম</a></div>
				    ...
				    <?php 
						...
						<ul>
                        <?php
					 $queryl1="select * from news_manage where category='32' and n_id!='$newsIdnat' 
