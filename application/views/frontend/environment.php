...
<body>
<?php
$querynat="select * from news_manage where category='13' and top_news=1 and status=1 order by n_id desc limit 1";
...
?>
<div class="row14_sub_right">
     							<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">পরিবেশ</a></div>
     				...
     				<div class="news_box_1">
                        ...
                        <?php 
							...
							if (strlen($stringbottom1nat) > 600) {
								$stringCutnat = substr($stringbottom1nat, 0, 600);
						...
						<ul>
                        <?php
					 $queryl1="select * from news_manage where category='13' and n_id!='$newsIdnat' 
					 and status=1 order by n_id desc limit 10";
