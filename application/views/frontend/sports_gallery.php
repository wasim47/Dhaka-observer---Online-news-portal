...
<div class="details_con1">
     		<div class="details_con1_left">
							<div class="common_header">খেলাধুলা</div>
...
<div id="wrapper">
           ...
           $queryl1s="select * from news_manage where category='6' and top_news=1 and status=1 order by n_id desc limit 7";
			...
			?>
									...
									<div class="sp_box1_right_sl2">
										<div class="common_header">খেলাধুলার শীর্ষ সংবাদ</div>
	...
	<li><span><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdl1;?>&&cat_id=<?php echo $categoryl1;?>" style="text-decoration:none;">
						...
						<div class="clearfloat"></div>
							...
							<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $cat_id; ?>&&scat_id=1&&page=1" style="color:#FFFFFF; text-decoration:none">ক্রিকেট</a></div>
							<div class="clearfloat"></div>													     	
     		<div class="gallery">
				<?php 
     		...
     		<div class="clearfloat"></div>	
							<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $cat_id; ?>&&scat_id=2&&page=1" style="color:#FFFFFF; text-decoration:none">ফুটবল</a></div>
     		...
     		<div class="clearfloat"></div>	
							<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $cat_id; ?>&&page=1" style="color:#FFFFFF; text-decoration:none">অন্যান্য</a></div>
     		...
     		<div class="details_con1_right">
							<div class="common_adbox_1"><img src="<?php echo base_url();?>assets/images/omega.jpg" width="344" height="400" class="smimg"></div>
							<div class="con_row-sp_right">
     						<div class="common_header" style="margin:27px 0 10px 0">লাইভ ক্রিকেট আপডেট</div>
                            ...
                            <?php include('cricinfo.php');?>
     						...
     						<div class="common_adbox_2"><img src="<?php echo base_url();?>assets/images/front/ad13.jpg" width="316" height="71" class="smimg"></div>
								...
								<div class="common_adbox_1"><img src="<?php echo base_url();?>assets/images/front/ad1.jpg" width="330" height="110" class="smimg"></div><div class="common_eventbox_1">
			     					<div class="common_eventbox_1_header">আপকামিং ক্রিকেট ম্যাচ</div>
