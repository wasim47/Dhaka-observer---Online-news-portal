        ...
        <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
                <?php
                        ...
                        $ph_ima=$photo ->ph_ima;
                    ?>
            <img src="<?php echo base_url();?>uploads/images/album_photo/<?php echo $ph_ima; ?>" title="<?php echo $ph_name;?>" width="544" height="340"/>
            <?php
        endforeach;
		?> 
            </div>
                        ...
                        ?>
     					...
     					<div class="con_row17_right">
     						<!--<div class="common_adbox_3"><img src="<?php echo base_url();?>assets/images/front/ad19.jpg" width="316" height="193" class="smimg"></div>-->
										<div class="common_header">হাওয়া বদল</div>	
