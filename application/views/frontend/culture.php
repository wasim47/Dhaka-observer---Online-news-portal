...
<body>
<?php
$querynat="select * from news_manage where category='15' and top_news=1 and status=1 order by n_id desc limit 1";
...
?>
<div class="row16_sub_right">
			     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">সাহিত্য - সংস্কৃতি</a></div>
												<div class="picture_box_1"><a href="<?php echo base_url();?>index/news_details?id=<?php echo $newsIdnat;?>&&cat_id=<?php echo $categorynat;?>" style="text-decoration:none; color:#333"><img src="<?php echo base_url();?>uploads/images/news/<?php echo $image_shortnat; ?>" width="660" height="390" class="smimg"></a></div>
						...
						<ul>
                        <?php
					 $queryl1="select * from news_manage where category='15' and n_id!='$newsIdnat' 
