...
<body>
<?php
$querynat="select * from news_manage where category='22' and top_news=1 and status=1 order by n_id desc limit 1";
...
<div class="row7_sub_right">
			     				<div class="common_header"><a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $categorynat; ?>&&page=1">ট্রেড ও শেয়ার</a></div>
						...
						<ul>
                        <?php
					 $queryl1="select * from news_manage where category='22' and n_id!='$newsIdnat' 
