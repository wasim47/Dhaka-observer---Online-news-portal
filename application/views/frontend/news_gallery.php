...
if(isset($_REQUEST['scat_id'])){
$subcat_id=$_REQUEST['scat_id'];
$resp2=mysql_query("select * from news_manage where sub_category='$subcat_id' and status=1 order by n_id desc limit $start, $limit");
					}
					else{
$resp2=mysql_query("select * from news_manage where category='$cat_id' and status=1 order by n_id desc limit $start, $limit");
...
//$resp2=mysql_query("select * from news_manage where category='$cat_id' and status=1 order by n_id desc limit $start, $limit");
                    ...
                    $count = 0;
					if($row=mysql_fetch_array($resp2)){
			...
			?>
     		...
     		<div class="details_con1_right">
                      ...
                      <img src="<?php echo base_url();?>assets/images/front/ad5.jpg" width="317" height="140" class="smimg">
								...
								?>
                                <div class="common_adbox_1">
                                <a href="<?php echo base_url(); ?>index/news_gallery?cat_id=<?php echo $cat_id; ?>&&scat_id=8&&page=1" style="color:#FFFFFF; text-decoration:none">
                                <img src="<?php echo base_url();?>assets/images/golpo.gif" width="317" height="140" class="smimg">
                                </a>
                                </div>
                                <?php
                                }
